...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        pos_lookat[2] += 0.35  # adjust the height of the camera lookat point
        # look from [1, 1, 1] to [0, 0, 0.5]
        sim.set_camera_view(pos_lookat + np.array([0.7, 0.7, 0.7]), pos_lookat)
